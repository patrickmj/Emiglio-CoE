...
<div id="primary">
    ...
    <ul id='mla-refs'>
        ...
        <li id='mla-bibliography-ref' class='mla-ref'>Bibliography <span class='mla-count'>(<?php echo $bibEntriesCount;?>)</span> <span class='action'>Hide</span></li>        
    </ul>  
