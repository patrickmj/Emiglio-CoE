...
<?php if($sort_field): ?>
<p>Showing all result sorted by name. Click letters below to limit the results.</p>

<?php endif; ?>
<ul class='pagination_list'>
<?php foreach($letters as $letter): ?>
<?php 
    $urlString = "items/browse/type/Commentator/starts_with/Dublin Core,Title,$letter";
    if($tag) {
